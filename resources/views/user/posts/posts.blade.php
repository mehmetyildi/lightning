...
@section('seo')
<title>Rehberlik Atölyesine Hoşgeldiniz</title>
    ...
    <div class="blog-item">
        <div class="blog-post">
            ...
            <div class="blogpost-img">
                <a href="#"><img style="max-height: 300px; max-width: 450px;" src="{{$post->image_url}}" alt="Post"></a>
            </div>
            @endif
           <!--  <div class="post-share">
            ...
            <div class="blogpost-info">
                ...
                <div class="post-meta">
                    ...
                    <span><a href="#"><i class="fa fa-clock-o"></i> {{$post->approved_at->toFormattedDateString()}}</a></span>
                </div>
                <p>{!!$post->body_medium!!}</p>
                <div class="read-more">
                    <a href="/{{$post->type()}}/show/{{$post->url}}" title="Read More">Devamı</a>
                </div>
            </div>
        </div>
    </div>
