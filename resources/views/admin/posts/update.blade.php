	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
					<br />
					<form id="demo-form2" method="POST" action="/posts/update/{{$post->id}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
						{{csrf_field()}}
						<img id="shown_img" style="max-height: 100px; max-width: 150px" class="col-md-offset-5 col-sm-offset-5 col-xs-offset-0" style="padding:30px;" src="{{$post->image_url}}">
						
						<div class="form-group resim-ekle resim-goster"> 
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Ana Resim Seç <span class="required">*</span>
							</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="file" id="selected_img"  name="image_url" class="form-control col-md-7 col-xs-12">
							</div>
						...
						@endforeach
						@endif
						@for($j=count($post->images);$j<10;$j++)
						...
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Post adı:<span class="required">*</span>
							</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="first-name" value="{{$post->title}}" name= "title" required="required" class="form-control col-md-7 col-xs-12">
							</div>
						</div>
