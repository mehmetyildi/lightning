  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          <br />
          <form id="demo-form2" method="POST" action="/book/update/{{$book->id}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">

            <div class="col-md-12">
              {{csrf_field()}}
              <div class="col-xs-12 col-md-6">
                <img id="shown_img" style="max-height: 100px; max-width: 150px" class="col-md-offset-5 col-sm-offset-5 col-xs-offset-0" style="padding:30px;" src="{{$book->image_url}}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8 col-sm-8 col-xs-12">
                    <select name="category_id" id="category_id" class="form-control">
                      ...
                      <option @if($book->category_id==$category->id) selected="selected"@endif value="{{$category->id}}">{{$category->title}}</option>
                      @endforeach
                    </select>
                  </div>
                ...
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Kitabın adı:<span class="required">*</span>
                  </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <input type="text" id="first-name" value="{{$book->title}}" name= "title" required="required" class="form-control col-md-7 col-xs-12">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-6">
                    <input type="text" id="first-name" value="{{$book->age_begin}}" name= "age_begin" required="required" class="form-control col-md-7 col-xs-12">
                  </div>
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-6">
                    <input type="text" id="first-name" value="{{$book->age_end}}" name= "age_end" required="required" class="form-control col-md-7 col-xs-12">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <input type="text" id="first-name" value="{{$book->author}}" name= "author" required="required" class="form-control col-md-7 col-xs-12">
                  </div>
                </div>

                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Çeviri:<span class="required">*</span>
                  </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <input type="text" id="first-name" value="{{$book->translated_by}}" name= "translated_by" required="required" class="form-control col-md-7 col-xs-12">
                  </div>
                </div>

                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Basımevi:<span class="required">*</span>
                  </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <input type="text" id="first-name" value="{{$book->publisher}}" name= "publisher" required="required" class="form-control col-md-7 col-xs-12">
                  </div>
                </div>


                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Basım Yılı:<span class="required">*</span>
                  </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <input type="text" id="first-name" value="{{$book->year}}" name= "year" required="required" class="form-control col-md-7 col-xs-12">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <select name="booktype_id" id="category_id" class="form-control">
                      @foreach($types as $type)
                      <option @if($book->booktype==$type->id) selected="selected" @endif value="{{$type->id}}">{{$type->type_name}}</option>
                      @endforeach
                    </select>
                  </div>
                  <!-- <i id="KategoriEklePlus" data-toggle="tooltip" data-placement="right" title="Kategori Ekle" class="fa fa-2x fa-plus-circle"></i> -->
                ...
                <div class="col-xs-12 col-md-6">
                  ...
                  <div  class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Yorum metni:<span class="required">*</span>
                    </label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
