...
<div class="">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          Hakkımızda öğelerini belirleyin
        </div>
        <div class="x_content">
          <br />
          <form id="demo-form2" method="POST" action="/about/update/{{$hakkimizda->id}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
            <img id="shown_img" style="max-height: 100px; max-width: 150px" class="col-md-offset-5 col-sm-offset-5 col-xs-offset-0" style="padding:30px;" src="{{$hakkimizda->image_url}}">
            {{csrf_field()}}     
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="first-name" value="{{$hakkimizda->title}}"  name= "title" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>

            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Hakkımızda içerik:<span class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
