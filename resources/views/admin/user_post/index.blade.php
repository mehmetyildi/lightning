		...
		<div class="x_panel">
			...
			<div class="x_content">
				<p class="text-muted font-13 m-b-30">
					Onay bekleyen kullanıcı yorumları (sizden gelenler) burada listelenmektedir. Makaleleri okumayı müteakip onaylayıp yayımlayabilir ya da yayımlamamayı seçip iptal edebilirsiniz.
				</p>
				<table id="datatable" class="table table-striped table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								@if(auth()->user()->hasRole('superadmin'))
								<a href="/user_post/show/{{$user_post->id}}"><button class="btn btn-info btn-xs"><i class="glyphicon glyphicon-book"></i>Gözat </button></a>
